...
public class CaseStudyApp extends JFrame {
    ...
    private void saveToFile(ArrayList<ArrayList<String>> data) {
        ...
        if (confirmed == JOptionPane.YES_OPTION) {
            try {
                // Tulis data ke file
                BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Users\\ammar\\IdeaProjects\\PP7\\src\\Pertemuan7\\data.txt"));
...
//                    Jika tombol "No" ditekan maka program akan tetap berjalan
        ...
        FormTabelModel tableModel = new FormTabelModel();
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                CaseStudyApp caseStudyApp = new CaseStudyApp();
                caseStudyApp.setVisible(true);
            }
        });
    }
}